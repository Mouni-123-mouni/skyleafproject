...
import com.skyleaf.repository.ReturnLink;
...
public class PayementMethod
{
	...
	@Autowired
	private Card1 cardRepository;

	@Autowired
	private CardRepository cardExpiryRepository;
	
	@Autowired
	private ReturnLink returnLinkRepository;
	...
	Iterable<ReturnLinks> returnLinks = returnLinkRepository.findAll();
